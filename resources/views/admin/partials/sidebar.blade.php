                ...
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="nav-submenu menu-content" style="display: none;">
                            <li><a href="widgets/general-widget.html">General</a></li>
                            <li><a href="widgets/chart-widget.html">Chart</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="nav-submenu menu-content" style="display: none;">
                            <li><a href="{{ route('admin.destination.index') }}">home</a></li>
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav " href="chat.html"><i data-feather="message-circle"></i><span>Chat</span></a>
                    </li>
                    <li class="dropdown">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="nav-submenu menu-content" style="display: none;">
                            <li><a href="maps/map-js.html">Maps JS</a></li>
