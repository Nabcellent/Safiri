                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="code-box-copy">
                                    <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#sell-overview" title="Copy">
                                        <i
                                            class="icofont icofont-copy-alt"></i></button>
                                    <pre><code class="language-html" id="sell-overview"> </code></pre>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card latest-update-sec">
                            ...
                            <div class="card-body">
                                ...
                                <div class="code-box-copy">
                                    ...
                                    <pre><code class="language-html" id="latest-update-sec"></code></pre>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-12 box-col-6 des-xl-50">
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="code-box-copy">
                                    <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#user-activations"
                                            title="Copy"><i
                                            class="icofont icofont-copy-alt"></i></button>
                                    <pre><code class="language-html" id="user-activations"></code></pre>
                                </div>
                            </div>
                        </div>
                    </div>
