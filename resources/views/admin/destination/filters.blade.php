	...
	<div class="row m-b-10">
		<div class="col-md-3 col-sm-2 products-total">
			<div class="square-product-setting d-inline-block">
				<a class="icon-grid grid-layout-view" href="javascript:void(0)" data-original-title="" title="">
					<i data-feather="grid"></i></a>
			</div>
			<div class="square-product-setting d-inline-block">
				<a class="icon-grid m-0 list-layout-view" href="javascript:void(0)" data-original-title="" title="">
			...
			<div class="grid-options d-inline-block">
				<ul>
					<li>
						<a class="product-2-layout-view" href="javascript:void(0)" data-original-title="" title="">
							...
							<div class="left-filter">
								<div class="card-body filter-cards-view animate-chk">
									...
									<div class="product-filter">
										...
										<div class="checkbox-animated mt-0">
											...
											<label class="d-block" for="chk-ani1"> <input class="checkbox_animated" id="chk-ani1"
											                                              ...
											                                              title=""/>Diesel </label>
											<label class="d-block" for="chk-ani2"> <input class="checkbox_animated" id="chk-ani2"
											                                              type="checkbox" data-original-title=""
											                                              title=""/>Lee </label>
											<label class="d-block" for="chk-ani3"> <input class="checkbox_animated" id="chk-ani3"
											                                              type="checkbox" data-original-title=""
											                                              title=""/>Hudson </label>
											<label class="d-block" for="chk-ani4"> <input class="checkbox_animated" id="chk-ani4"
											                                              type="checkbox" data-original-title=""
											                                              title=""/>Denizen </label>
											<label class="d-block" for="chk-ani5"> <input class="checkbox_animated" id="chk-ani5"
											                                              type="checkbox" data-original-title=""
											                                              title=""/>Spykar </label>
										</div>
									</div>
										...
										<div class="owl-carousel owl-theme" id="testimonial">
											<div class="item">
												<div class="product-box">
													<div class="media">
														<div class="product-img me-3"><img class="img-fluid"
														                                   src="/images/admin/ecommerce/01.jpg" alt=""
												...
												<div class="product-box">
													<div class="media">
														<div class="product-img me-3">
															<img class="img-fluid" src="/images/admin/ecommerce/02.jpg" alt="" data-original-title="" title=""/>
														</div>
														<div class="media-body">
															<div class="product-details">
																<div>
												...
												<div class="product-box">
													<div class="media">
														<div class="product-img me-3"><img class="img-fluid"
														                                   src="/images/admin/ecommerce/03.jpg" alt=""
														                                   data-original-title="" title=""/></div>
														<div class="media-body">
															<div class="product-details">
																<div>
											...
											<div class="item">
												...
												<div class="product-box">
													<div class="media">
														<div class="product-img me-3"><img class="img-fluid"
														                                   src="/images/admin/ecommerce/02.jpg" alt=""
														                                   data-original-title="" title=""/></div>
														<div class="media-body">
															<div class="product-details">
																<div>
												...
												<div class="product-box">
													<div class="media">
														<div class="product-img me-3">
															<img class="img-fluid" src="/images/admin/ecommerce/03.jpg" alt=""
									...
									<div class="product-filter text-center">
										<img class="img-fluid banner-product" src="/images/admin/ecommerce/banner.jpg" alt=""
										     data-original-title="" title=""/>
									</div>
								</div>
							</div>
