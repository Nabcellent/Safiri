...
} else if (PAGE_WRAPPER_ID.hasClass('horizontal-wrapper')) {
    let contentwidth = jQuery(window).width();
    if ((contentwidth) < '992') {
        PAGE_WRAPPER_ID.removeClass('horizontal-wrapper').addClass('compact-wrapper');
